...
echo 'export PATH="/home/is/yuka-ko/.pyenv/bin:$PATH"' >> ~/.bashrc
echo 'eval "$(pyenv init -)"' >> ~/.bashrc
source ~/.bashrc

vim ~/.bashrc
echo 'export PATH="/home/is/yuka-ko/.pyenv/bin:$PATH"' >> ~/.bash_profile
...
pyenv install -l
source ~/.bashrc
echo 'export PATH="/home/is/yuka-ko/.local/bin:$PATH"' >> ~/.bashrc
